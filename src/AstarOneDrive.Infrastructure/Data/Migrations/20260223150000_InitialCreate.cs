    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.CheckConstraint("CK_SyncFiles_LocalPath_Length", "length(LocalPath) <= 1024");
                table.CheckConstraint("CK_SyncFiles_Name_Length", "length(Name) <= 260");
                table.CheckConstraint("CK_SyncFiles_RemotePath_Length", "length(RemotePath) <= 1024");
                table.ForeignKey(
