...
/// <param name="LocalSyncRootPath">The account-specific local sync root path.</param>
public sealed record AccountState(string Id, string Email, long QuotaBytes, long UsedBytes, string LocalSyncRootPath = "");
